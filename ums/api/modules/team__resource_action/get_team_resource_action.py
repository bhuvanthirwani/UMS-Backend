...
from .queries import find_resource_action_by_role
from sqlalchemy.orm.exc import NoResultFound

LOGGER = logging.getLogger()

FIND_ROLE_RESOURCE_ACTION_ENDPOINT = "/role-resource-permission"


class FindRoleResourceActionResource(BaseResource):
    ...
    def get(self):
        try:
            ...
            json_res = []
            if role_name:
                json_res = find_resource_action_by_role(role_name=role_name)
